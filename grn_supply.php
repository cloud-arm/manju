                ...
                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="person" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="box box-primary">
                            ...
                            $result = select_query("SELECT * FROM supplier WHERE id= '$id' ");
                                    ...
                                    for ($i = 0; $row = $result->fetch(); $i++) {  ?>
                                        ...
                                        <tr class="record">
                                            ...
                                            <td style="display: flex; align-items: center;justify-content: space-around;">
                                                ...
                                                <a href="grn_supply.php?id=<?php echo $row['id']; ?>" class="up_btn btn btn-warning" title="Click to Delete">
