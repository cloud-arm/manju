                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                            ...
                            <div class="box-body d-block">
                                ...
                                <form method="POST" action="save/tr_extra_save.php" class="w-100">

                                    <div class="row">

                                    <div class="col-md-3">
                        <div class="form-group">
                        <?php $result = select('repair','*','id='.$id);
                ...
                <input type="text" name="veh_no" class="form-control" value="<?php echo htmlspecialchars($number); ?>" readonly>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="rep_type" class="form-control" value="<?php echo htmlspecialchars($type); ?>" readonly>
                                ...
                                <div class="form-group">
                                        ...
                                        <select name="parts" id="select2" class="form-control select2" >   
                                                <?php $result = select('tr_parts_list');  
                                                for ($i = 0; $row = $result->fetch(); $i++) { 
                                                ?>    
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Value</label>
                                                <input type="text" name="value1" class="form-control" autocomplete="off" required>
                                            </div>
                                        </div>
                        ...
                        <div class="box-body d-block">
                            <table id="example2" class="table table-bordered ">
                                ...
                                <tbody>
                                    ...
                                    $result = query("SELECT * FROM tr_parts_record WHERE vehicle_no='$number1' ORDER BY id DESC");
                                    for ($i = 0; $row = $result->fetch(); $i++) {  ?>
