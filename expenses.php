        ...
        <div class="col-md-6 model_add_1" style="display: none;">
          <div class="box box-primary model_add_1">
            ...
            <div class="box-body">
              ...
              <form method="POST" action="save/expenses_save.php">
        ...
        <div class="box-body d-block">
          <form method="post" action="save/expenses_save.php">
            <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <select class="form-control" name="type" style="width: 100%;" id="ex_type" onchange="select_type()" tabindex="1">
                    ...
                    <?php
                    $result = select_query("SELECT * FROM expenses_types ");
              ...
              <div class="col-md-3" id="acc_sec">
                <div class="form-group">
                  ...
                  <select class="form-control " name="acc" style="width: 100%;" tabindex="3">
                    <?php
                    $result = select_query("SELECT * FROM cash ");
                    for ($i = 0; $row = $result->fetch(); $i++) {
                    ?>
              ...
              <div class="col-md-3 bank_sec" style="display: none;">
                <div class="form-group">
                  ...
                  <select class="form-control " name="bank" style="width: 100%;" tabindex="4">
                    ...
                    <?php
                    $result = select_query("SELECT * FROM bank ");
                    for ($i = 0; $row = $result->fetch(); $i++) {
                    ?>
              ...
              <div class="col-md-3 util_sec" style="display: block;">
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="util_id" style="width: 100%;" tabindex="8" onchange="select_bill(this.options[this.selectedIndex].getAttribute('balance'))">
                    ...
                    <?php
                    $result = select_query("SELECT * FROM utility_bill  ");
                    for ($i = 0; $row = $result->fetch(); $i++) {
                    ?>
              ...
              <div class="col-md-3 util_rep" style="display: block;">
                  <div class="form-group">
                    <label>Tool Gate</label> 
                    <span id="blc" class="badge bg-red"></span>
                    <select class="form-control select2" name="util_gate_pass" style="width: 100%;" tabindex="8" onchange="select_bill(this.options[this.selectedIndex].getAttribute('balance'))">
                      <option value="0" balance=""></option>
                      <?php
                      // Fetch data from the database
                      $result = select_query("SELECT * FROM gate_pass WHERE action='out' AND location_id='2'"); 
  ...
  <script type="text/javascript">
    ...
    function select_type() {
      ...
      if (val == 1) {
        ...
        $('.util_rep').css('display', 'block');
      }
       else {
        $('.util_sec').css('display', 'none');
        $('.util_rep').css('display', 'none');
