...
function cash_transaction($id, $type, $amount, $transaction_type, $record_no, $action = 0)
{
    ...
    $blc = 0;
    $result = select("cash", "name,amount", "id = '" . $id . "'");
    ...
    $insertData = array(
        ...
        "other" => array(
            "data_id" => $id,
            "data_name" => "cash_transaction",
        ),
    );
    return insert("transaction_record", $insertData);
}
