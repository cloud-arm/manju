...
if ($user_l == "admin") { ?>
                    ...
                    <div class="model-box v-4">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <h4 style="color:#686868">Total</h4>
                               ...
                               /*         $result1 = select('user', '*');
                                        if ($result1) {
                                            ...
                                            */
                                       $result = $db->prepare("SELECT count(id)  FROM purchases_list  WHERE invoice_no='$invo' AND type='Order'");
    ...
    <div class="box-header">
        <h3 class="box-title">Approve GRN LIST</h3>

        <div class="row">
    <?php
    $result = select('purchases_list', '*', "invoice_no='$invo' AND type='Order'", '../');
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div style="border-radius: 15px; background-color: #181929; color: aliceblue; margin: 2%; padding: 10px;">
                    <table style="width:100%;">
                        <tr>
                            <td>
                                <h3 style="color: #89CFF0; margin: 10px;"><?php echo $row['name'].$row['id']; ?></h3>
                            </td>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <div align="left" style="width:100%;">
                                    ...
                                    <div
                                        ...
                                        <strong>Price:</strong> <?php echo $row['sell']; ?><br><br>
                                        <strong>Quantity:</strong> <?php echo $row['qty']; ?><br>                                        </div>
                            ...
                            <td>
                                <div align="right" style="width:100%;">
                                    ...
                                    <div
                                        style="color:#6d949e; background-color: #B2BEB5; text-align: center; border-radius: 10px 10px 10px 10px ;">
                                        <strong>Amount:</strong> <?php echo $row['sell'] * $row['qty']; ?>
                                        </div>
                    ...
                    <table >
                        <tr>
                            ...
                            <?php if ($approved != 1 && $approved != 5): ?>
                                    ...
                                    <a class="btn btn-warning"  onclick="confirmApp(<?php echo $row['id']; ?>)">
                                ...
                                <?php if ($approved == 1): ?>
                                    <!-- Edit button (blue) -->
                                    <a class="btn btn-primary" onclick="edit_note(<?php echo $id; ?>)">
                                        <i class="fas fa-edit"></i> Aproved
                                    </a>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div align="right" style="width:100%;">
                                <a href="report.php?id=<?php echo $id; ?>">                                        <div class="bg-primary"
