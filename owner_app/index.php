                    ...
                    <div class="model-box v-4">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <h4 style="color:#686868">Total Running jobs</h4>
                               ...
                               /*         $result1 = select('user', '*');
                                        if ($result1) {
                                            ...
                                            */
                                       $result = $db->prepare("SELECT count(id)  FROM job  WHERE status != 'finish '");
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div style="border-radius: 15px; background-color: #181929; color:aliceblue; margin: 2%;">
                    <table style="width:100%;">
                        <tr>
                            <td>
                                <h4 style="color:#afb3b8; margin: 10px;"><?php echo $row['name']; ?></h4>
                        ...
                        <tr>
                            <td>
                                <?php
                        $r = select('job_location', '*', 'job_id=' . $row['id'],'../');
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="left" style="width:100%;">
                                    ...
                                    <div
                                        style="color:#dbdbdb; background-color: #1f2031; text-align: center; border-radius: 0px 15px 0px 15px ;">
                                        <?php echo $row['all_job_no']; ?></div>
                            ...
                            <td>
                                <div align="right" style="width:100%;">
                                    <a onclick="notifyOptions();" href="mob_job_view.php?id=<?php echo $id ?>">
