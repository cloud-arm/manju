...
<table>
    <tr>
        ...
        <th style="padding: 20px; background-color: #333; color: #fff; border-radius: 8px;">
            <div style="display: flex; flex-direction: column; align-items: flex-start;">
                <?php
                $location_id = $_GET['location_id'];
                $result = select('job_location', '*', 'location_id=' . $location_id, '../');
                
                if ($result) {
                    $row = $result->fetch();
                ?>
                    <h3 style="margin: 0; font-size: 1.5em;"><?php echo $row['company_name']; ?></h3>
                    <h5 style="margin: 0; font-size: 1.2em; color: #ddd;"><?php echo $row['name']; ?></h5>
    ...
    <div class="hederbar" style="overflow-x:auto;">
        ...
        <div class="box-header">
            ...
            <div class="row">
                ...
                $job_no = ($_GET['job_id']);
               // echo "$location_id";
               $result = select('sales_list', '*', 'location_id=' . $location_id . ' AND job_no ='.$job_no,'../');
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div style="border-radius: 15px; background-color: #181929; color:aliceblue; margin: 2%; padding: 10px;">
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    <h3 style="color:#D1D1D1; margin: 10px;"><?php echo $row['name']; ?></h3>
                                </td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div align="right" style="width:100%;">
                                        <a href="task_form.php?id=<?php echo $row['id']; ?>">
                                            <div class="bg-red" style="color:#dbdbdb; width:100px; text-align: center; border-radius: 15px 0px 15px 0px;">
                                                Collect
                                            </div>
                                        </a>
                                    </div>
