...
<body class="hold-transition skin-yellow sidebar-mini sidebar-collapse">
  ...
  <script>
    ...
    function fetchGPSData() {
      ...
      marker2.bindPopup('Thimal'); // Bind popup instead of label
      var Ico = '';
      fetch('map_data.php')
        ...
        .then(data => {
          ...
          data.forEach(entry => {
            ...
            marker.bindPopup(
              ...
              '<span style="font-size:12px;">' + data2 + '</span>' +
              '<span style="font-size:12px;">' + data3 + '</span>' +
              '</div>'
            );
          });
        })
